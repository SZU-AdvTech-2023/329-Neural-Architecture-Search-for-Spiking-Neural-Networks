            ...
            for row in range(col):
                ...
                if op==0:
                    ...
                    self.cell_architecture.append(nn.Sequential(
                        neuron.ParametricLIFNode(v_threshold=args.threshold, v_reset=0.0, init_tau=args.tau,
                    ...
                    # self.cell_architecture.append(nn.MaxPool2d(kernel_size=3, stride=1, padding=1))
        ...
        for col in range(0, 3):
            for row in range(col+1, 4):
                ...
                if op == 0:
                    ...
                    # self.cell_architecture_back.append(nn.MaxPool2d(kernel_size=3, stride=1, padding=1))
