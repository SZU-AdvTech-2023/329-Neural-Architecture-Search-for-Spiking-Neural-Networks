...
def get_args():
    ...
    parser.add_argument('--data_dir', type=str, default='/data/laipeilin/project/NAS4SNN/dataset/', help='path to the dataset')
    ...
    parser.add_argument('--tau', type=float, default=2.0, help='neuron decay time factor')
