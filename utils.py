...
def save_checkpoint(state, iters, tag=''):
    if not os.path.exists("/data/laipeilin/project/NAS4SNN/snapshots"):
        os.makedirs("/data/laipeilin/project/NAS4SNN/snapshots")
    filename = os.path.join("/data/laipeilin/project/NAS4SNN/snapshots/{}_ckpt_{:04}.pth.tar".format(tag, iters))
