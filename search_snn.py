...
def main():
    ...
    if args.dataset == 'cifar10':
        ...
        trainset = torchvision.datasets.ImageFolder(os.path.join('/data/laipeilin/project/NAS4SNN/dataset/tiny-imagenet-200/train'),
                                        train_transform)
        valset = torchvision.datasets.ImageFolder(os.path.join('/data/laipeilin/project/NAS4SNN/dataset/tiny-imagenet-200/val'),
                                      valid_transform)
